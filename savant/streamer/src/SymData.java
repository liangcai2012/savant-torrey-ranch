...
public class SymData {
	...
	public long update(long second, long vol, double price, int type){
		synchronized(this){ 
			System.out.print("SymDataUpdating");
			if (lastSecond > second){
			//this not should not happen, as second is a value generated by Streamer based on event time (not timestamp)
